    ...
    <>
      ...
      <Container>
        ...
        <Typography pr={{ xs: '0%', md: '45%' }} pb={{ xs: '0%', md: '2%' }}>
          Step into style with our unbeatable selection of shoes! From the streets to the office, our shoes are the
        ...
        <Grid container spacing={3} p={2}>
          ...
          <Grid item xs={12} sm={9}>
            <Typography pt={2} pb={2} align="justify">
              Are you ready to elevate your shoe game? Look no further than our collection of fashionable and
              comfortable footwear. We offer a variety of styles to choose from, so you can find the perfect pair to
              suit your personal style. From the office to a night out on the town, our shoes are the perfect addition
              to any outfit. Don't miss out on the opportunity to upgrade your shoe collection. Shop now and step up
              your style!
            </Typography>
